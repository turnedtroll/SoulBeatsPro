/*
 * larpLOL_perfect.cpp  —  Funky Friday macro, NO variation, perfect Sick hits only
 *
 * Build:
 *   g++ -O2 -std=c++17 -o larpLOL_perfect.exe larpLOL_perfect.cpp -lgdi32 -luser32 -lkernel32
 *
 * Handles:
...
static void run_macro(Config cfg){
    ...
    std::cout<<"[larpLOL_perfect] Running | L = pause/resume\n";
...
int main(){
    ...
    std::cout<<"larpLOL_perfect | All Sick | No variation\n";
